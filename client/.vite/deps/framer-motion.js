    ...
    if (true) {
      (function () {
        ...
        var ReactSharedInternals =
          React4.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
...
var PresenceChild = ({
  ...
  const memoizedOnExitComplete = (0, import_react6.useCallback)(
    (childId) => {
  ...
  const context = (0, import_react6.useMemo)(
    ...
    presenceAffectsLayout
      ...
      : [isPresent2, memoizedOnExitComplete],
  );
...
function usePresence(subscribe = true) {
  ...
  const safeToRemove = (0, import_react7.useCallback)(
    () => subscribe && onExitComplete && onExitComplete(id4),
    [id4, onExitComplete, subscribe],
  );
...
var AnimatePresence = ({
  ...
  const presentChildren = (0, import_react10.useMemo)(
  ...
  const [diffedChildren, setDiffedChildren] = (0, import_react10.useState)(
    presentChildren,
  );
  const [renderedChildren, setRenderedChildren] = (0, import_react10.useState)(
    presentChildren,
  );
...
function createRenderBatcher(scheduleNextBatch, allowKeepAlive) {
  ...
  const processBatch = () => {
    const timestamp = MotionGlobalConfig.useManualTiming
      ...
      : performance.now();
    runNextFrame = false;
    state2.delta = useDefaultElapsed
      ? 1e3 / 60
      : Math.max(Math.min(timestamp - state2.timestamp, maxElapsed), 1);
...
function useForceUpdate() {
  ...
  import_react13.useState)(0);
  const forceRender = (0, import_react13.useCallback)(() => {
    isMounted.current && setForcedRenderCount(forcedRenderCount + 1);
  }, [forcedRenderCount]);
  const deferredForceRender = (0, import_react13.useCallback)(
...
var LayoutGroup = ({ children, id: id4, inherit = true }) => {
  ...
  const deprecatedLayoutGroupContext = (0, import_react14.useContext)(
...
function useCreateMotionContext(props) {
  const { initial, animate: animate2 } = getCurrentTreeVariants(
    props,
    (0, import_react19.useContext)(MotionContext),
  );
  return (0, import_react19.useMemo)(
    () => ({ initial, animate: animate2 }),
...
var { schedule: microtask, cancel: cancelMicrotask } = createRenderBatcher(
  queueMicrotask,
  false,
);
...
function useVisualElement(
  ...
  var _a, _b;
  const { visualElement: parent } = (0, import_react22.useContext)(
    MotionContext,
  );
  ...
  const reducedMotionConfig = (0, import_react22.useContext)(
    MotionConfigContext,
  ).reducedMotion;
  ...
  const initialLayoutGroupConfig = (0, import_react22.useContext)(
  ...
  const wantsHandoff = (0, import_react22.useRef)(
  ...
  (0, import_react22.useEffect)(() => {
    ...
    if (wantsHandoff.current) {
      queueMicrotask(() => {
        var _a2;
        (_a2 = window.MotionHandoffMarkAsComplete) === null || _a2 === void 0
          ? void 0
...
function createRendererMotionComponent({
    ...
    return (0, import_jsx_runtime7.jsxs)(MotionContext.Provider, {
      ...
      children: [
        MeasureLayout2 && context.visualElement
          ? (0, import_jsx_runtime7.jsx)(MeasureLayout2, {
  ...
  const ForwardRefMotionComponent = (0, import_react23.forwardRef)(
    MotionComponent,
  );
...
function getProjectionFunctionality(props) {
  ...
  return {
    MeasureLayout:
      ...
      (layout2 === null || layout2 === void 0
        ? void 0
        : layout2.isEnabled(props))
...
function getValueState(visualElement) {
  const state2 = [{}, {}];
  visualElement === null || visualElement === void 0
    ? void 0
...
function makeState(
  ...
  if (onUpdate) {
    state2.onMount = (instance) =>
      onUpdate({ props, current: instance, ...state2 });
...
var checkStringStartsWith = (token) => (key) =>
  ...
  for (const key in style) {
    if (
      ...
      ((_a =
        visualElement === null || visualElement === void 0
          ? void 0
          : visualElement.getValue(key)) === null || _a === void 0
        ? void 0
        : _a.liveStyle) !== void 0
    ) {
...
function scrapeMotionValuesFromProps2(props, prevProps, visualElement) {
  const newValues = scrapeMotionValuesFromProps(
    props,
    prevProps,
    visualElement,
  );
...
function createUseRender(forwardMotionProps = false) {
  const useRender = (Component3, props, ref, { latestValues }, isStatic) => {
    const useVisualProps = isSVGComponent(Component3)
      ? useSVGProps
      : useHTMLProps;
    ...
    const elementProps =
      Component3 !== import_react27.Fragment
        ? { ...filteredProps, ...visualProps, ref }
        : {};
    const { children } = props;
    const renderedChildren = (0, import_react27.useMemo)(
...
function createMotionComponentFactory(preloadedFeatures, createVisualElement) {
  return function createMotionComponent2(
    Component3,
    { forwardMotionProps } = { forwardMotionProps: false },
  ) {
    const baseConfig = isSVGComponent(Component3)
      ? svgMotionConfig
      : htmlMotionConfig;
    const config = {
      ...baseConfig,
...
var NativeAnimationControls = class {
  ...
  get duration() {
    ...
    const durationInMs =
      ((_b =
        (_a = this.animation) === null || _a === void 0
          ? void 0
          : _a.effect) === null || _b === void 0
        ? void 0
        : _b.getComputedTiming().duration) ||
...
function memoSupports(callback, supportsFlag) {
  ...
  return () => {
    var _a;
    return (_a = supportsFlags[supportsFlag]) !== null && _a !== void 0
      ? _a
      : memoized();
  };
}
...
var cubicBezierAsString = ([a, b, c, d]) =>
...
function resolveElements(elementOrSelector, scope, selectorCache) {
  ...
  if (elementOrSelector instanceof Element) {
    ...
    const elements =
      (_a =
        selectorCache === null || selectorCache === void 0
          ? void 0
          : selectorCache[elementOrSelector]) !== null && _a !== void 0
        ? _a
...
function press(elementOrSelector, onPressStart, options = {}) {
  ...
  const startPress = (startEvent) => {
    ...
    const onPointerUp = (upEvent) => {
      onPointerEnd(
        upEvent,
        options.useGlobalTarget || isNodeOrChild(element, upEvent.target),
      );
    };
...
function test(v) {
  ...
  return (
    ...
    (((_a = v.match(floatRegex)) === null || _a === void 0
      ? void 0
      : _a.length) || 0) +
      (((_b = v.match(colorRegex)) === null || _b === void 0
        ? void 0
        : _b.length) || 0) >
      0
  );
...
function makeNoneKeyframesAnimatable(
  ...
  if (animatableTemplate && name) {
    for (const noneIndex of noneKeyframeIndexes) {
      unresolvedKeyframes[noneIndex] = getAnimatableNone2(
        name,
        animatableTemplate,
      );
    }
...
var nonTranslationalTransformKeys = transformPropOrder.filter(
    ...
    elementsToMeasure.forEach((element) => {
      ...
      if (restore) {
        restore.forEach(([key, value]) => {
          var _a;
          (_a = element.getValue(key)) === null || _a === void 0
            ? void 0
            : _a.set(value);
        });
      }
  ...
  readKeyframes() {
    ...
    for (let i = 0; i < unresolvedKeyframes.length; i++) {
      if (unresolvedKeyframes[i] === null) {
        if (i === 0) {
          const currentValue =
            motionValue2 === null || motionValue2 === void 0
              ? void 0
              : motionValue2.get();
          const finalKeyframe =
...
function canAnimate(keyframes2, name, type, velocity) {
  ...
  return (
    hasKeyframesChanged(keyframes2) ||
...
function getFinalKeyframe(
  ...
  return !index || finalKeyframe === void 0
  ...
  onKeyframesResolved(keyframes2, finalKeyframe) {
    ...
    if (!isGenerator2 && !canAnimate(keyframes2, name, type, velocity)) {
      if (instantAnimationState.current || !delay2) {
        onUpdate &&
          onUpdate(getFinalKeyframe(keyframes2, this.options, finalKeyframe));
...
function matchOrder(origin, target) {
  ...
  for (let i = 0; i < target.values.length; i++) {
    ...
    const originValue =
      (_a = origin.values[originIndex]) !== null && _a !== void 0 ? _a : 0;
...
function getSpringOptions(options) {
  ...
  if (
    ...
    if (options.visualDuration) {
      ...
      const damping =
        2 * clamp(0.05, 1, 1 - (options.bounce || 0)) * Math.sqrt(stiffness);
      springOptions = {
        ...springOptions,
        mass: springDefaults.mass,
        stiffness,
...
function interpolate(
  input,
  output,
  { clamp: isClamp = true, ease: ease2, mixer } = {},
) {
...
var MainThreadAnimation = class extends BaseAnimation {
  constructor(options) {
    ...
    const onResolved = (resolvedKeyframes, finalKeyframe) =>
      this.onKeyframesResolved(resolvedKeyframes, finalKeyframe);
    this.resolver = new KeyframeResolver$1(
      keyframes2,
      onResolved,
      name,
      motionValue2,
  ...
  tick(timestamp, sample = false) {
    ...
    const timeWithoutDelay =
      this.currentTime - delay2 * (this.speed >= 0 ? 1 : -1);
    const isInDelayPhase =
      this.speed >= 0 ? timeWithoutDelay < 0 : timeWithoutDelay > totalDuration;
  ...
  play() {
    ...
    if (this.holdTime !== null) {
      ...
      this.startTime =
        startTime !== null && startTime !== void 0
          ? startTime
          : this.calcStartTime();
...
var AcceleratedAnimation = class extends BaseAnimation {
  ...
  initPlayback(keyframes2, finalKeyframe) {
    ...
    const animation = startWaapiAnimation(
      motionValue2.owner.current,
      name,
      keyframes2,
      { ...this.options, duration, times, ease: ease2 },
    );
    animation.startTime =
      startTime !== null && startTime !== void 0
        ? startTime
    ...
    if (this.pendingTimeline) {
      ...
      animation.onfinish = () => {
        const { onComplete } = this.options;
        motionValue2.set(
          getFinalKeyframe(keyframes2, this.options, finalKeyframe),
        );
        onComplete && onComplete();
        this.cancel();
        this.resolveFinishedPromise();
...
function animateTarget(
  ...
  for (const key in target) {
    const value = visualElement.getValue(
      key,
      (_a = visualElement.latestValues[key]) !== null && _a !== void 0
        ? _a
        : null,
    );
...
var AnimationFeature = class extends Feature {
  ...
  unmount() {
    ...
    (_a = this.unmountControls) === null || _a === void 0
      ? void 0
      : _a.call(this);
  }
};
...
function applyConstraints(point2, { min, max }, elastic) {
  if (min !== void 0 && point2 < min) {
    point2 = elastic
      ? mixNumber(min, point2, elastic.min)
      : Math.max(point2, min);
  } else if (max !== void 0 && point2 > max) {
    point2 = elastic
      ? mixNumber(max, point2, elastic.max)
      : Math.min(point2, max);
  }
  return point2;
}
...
function animateSingleValue(value, keyframes2, options) {
  ...
  motionValue$1.start(
    animateMotionValue("", motionValue$1, keyframes2, options),
  );
  ...
  for (let i = 0; i < numBorders; i++) {
    ...
    if (canMix) {
      target[borderLabel] = Math.max(
        mixNumber(asNumber(followRadius), asNumber(leadRadius), progress2),
        0,
      );
...
function getRadius(values, radiusName) {
  return values[radiusName] !== void 0
    ? values[radiusName]
    : values.borderRadius;
}
...
function buildProjectionTransform(delta, treeScale, latestTransform) {
  ...
  const zTranslate =
    (latestTransform === null || latestTransform === void 0
      ? void 0
      : latestTransform.z) || 0;
...
function createProjectionNode2({
  ...
  return class ProjectionNode {
    ...
    scheduleRender(notifyAll2 = true) {
      var _a;
      (_a = this.options.visualElement) === null || _a === void 0
        ? void 0
        : _a.scheduleRender();
      if (notifyAll2) {
        const stack = this.getStack();
...
function notifyLayoutUpdate(node) {
  var _a;
  const snapshot =
    ((_a = node.resumeFrom) === null || _a === void 0 ? void 0 : _a.snapshot) ||
    node.snapshot;
  if (
    node.isLead() &&
    node.layout &&
...
function checkNodeWasScrollRoot(node) {
  ...
  return (
    node !== node.root &&
    ((_a = node.scroll) === null || _a === void 0 ? void 0 : _a.wasRoot)
  );
}
...
function updateMotionValuesFromProps(element, next, prev) {
  for (const key in next) {
    ...
    if (isMotionValue(nextValue)) {
      ...
      if (true) {
        warnOnce(
          nextValue.version === "11.18.2",
          `Attempting to mix Motion versions ${nextValue.version} with 11.18.2 may not work as expected.`,
        );
      }
  ...
  getBaseTarget(key) {
    ...
    if (typeof initial === "string" || typeof initial === "object") {
      const variant = resolveVariantFromProps(
        this.props,
        initial,
        (_a = this.presenceContext) === null || _a === void 0
          ? void 0
          : _a.custom,
      );
      if (variant) {
...
var createDomVisualElement = (Component3, options) => {
  return isSVGComponent(Component3)
...
function updateAxisInfo(element, axisName, info, time2) {
  ...
  axis.velocity =
    elapsed > maxElapsed2 ? 0 : velocityPerSecond(axis.current - prev, elapsed);
}
...
var getEventTarget = (element) =>
  element === document.documentElement ? window : element;
function scrollInfo(
  onScroll,
  { container = document.documentElement, ...options } = {},
) {
...
function useReducedMotion() {
  ...
  const [shouldReduceMotion] = (0, import_react35.useState)(
    prefersReducedMotion.current,
  );
  if (true) {
    warnOnce(
...
function createAnimationsFromSequence(
  ...
  for (let i = 0; i < sequence.length; i++) {
    ...
    const resolveValueSequence = (
      ...
      let { ease: ease2 = defaultTransition.ease || "easeOut", duration } =
        valueTransition;
      const calculatedDelay =
        typeof delay2 === "function"
          ? delay2(elementIndex, numSubjects)
          : delay2;
      const numKeyframes = valueKeyframesAsList.length;
      const createGenerator = isGenerator(type)
        ? type
        : generators2 === null || generators2 === void 0
          ? void 0
          : generators2[type];
...
function isSingleValue(subject, keyframes2) {
  return (
    ...
    (typeof subject === "string" && !isDOMKeyframes(keyframes2))
  );
}
function animateSubject(subject, keyframes2, options, scope) {
  ...
  if (isSingleValue(subject, keyframes2)) {
    ...
    for (let i = 0; i < numSubjects; i++) {
      ...
      animations2.push(
        ...animateTarget(visualElement, { ...keyframes2, transition }, {}),
      );
    }
  }
  return animations2;
...
function animateSequence(sequence, options, scope) {
  ...
  animationDefinitions.forEach(
    ({ keyframes: keyframes2, transition }, subject) => {
...
function hydrateKeyframes(valueName, keyframes2, read) {
  for (let i = 0; i < keyframes2.length; i++) {
    ...
    if (
      typeof keyframes2[i] === "number" &&
      browserNumberValueTypes[valueName]
    ) {
      keyframes2[i] = browserNumberValueTypes[valueName].transform(
        keyframes2[i],
      );
    }
  }
  ...
  constructor(element, valueName, valueKeyframes, options) {
    ...
    const onFinish = () => {
      this.setValue(
        element,
        valueName,
        getFinalKeyframe(valueKeyframes, options),
      );
      this.cancel();
      this.resolveFinishedPromise();
    };
...
function animateElements(elementOrSelector, keyframes2, options, scope) {
  ...
  for (let i = 0; i < numElements; i++) {
    ...
    for (const valueName in keyframes2) {
      ...
      animations2.push(
        new NativeAnimation(element, valueName, valueKeyframes, valueOptions),
      );
    }
  }
  return animations2;
...
var createScopedWaapiAnimate = (scope) => {
  function scopedAnimate(elementOrSelector, keyframes2, options) {
    return new GroupPlaybackControls(
      animateElements(elementOrSelector, keyframes2, options, scope),
    );
  }
  return scopedAnimate;
};
...
function handoffOptimizedAppearAnimation(elementId, valueName, frame2) {
  ...
  function cancelAnimation() {
    var _a2;
    (_a2 = window.MotionCancelOptimisedAnimation) === null || _a2 === void 0
      ? void 0
      : _a2.call(window, elementId, valueName, frame2);
  }
    ...
    window.MotionCheckAppearSync = (visualElement, valueName, value) => {
      ...
      const removeSyncCheck = value.on("change", (latestValue) => {
        ...
        if (externalAnimationValue.get() !== latestValue) {
          (_a2 = window.MotionCancelOptimisedAnimation) === null ||
          _a2 === void 0
            ? void 0
            : _a2.call(window, appearId, valueName);
          removeSyncCheck();
        }
      });
...
function useAnimatedState(initialState) {
  const [animationState, setAnimationState] = (0, import_react43.useState)(
    initialState,
  );
...
function ReorderItemComponent(
  ...
  const zIndex = useTransform([point2.x, point2.y], ([latestX, latestY]) =>
...
function stagger(
  duration = 0.1,
  { startDelay = 0, from = 0, ease: ease2 } = {},
) {
  return (i, total) => {
    const fromIndex =
